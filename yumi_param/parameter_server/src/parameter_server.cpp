...
namespace parameter_server 
{
	...
	rclcpp::Node("parameter_server", options)
	{
		...
		get_robot_srv_ = this->create_service<GetRobot>("GetRobot", fcn1, 
																										 rmw_qos_profile_services_default);
		
		auto fcn2 = std::bind(&ParameterServer::handle_GetPort, this, _1, _2, _3);
		get_port_srv = this->create_service<GetPort>("GetPort", fcn2, 
																								  rmw_qos_profile_services_default);

		auto fcn3 = std::bind(&ParameterServer::handle_GetAllJoints, this, _1, _2, _3);
		get_all_joints_srv_ = this->create_service<GetAllJoints>("GetAllJoints", fcn3, 
																															rmw_qos_profile_services_default);
		...
		get_controller_joints_srv_ = this->create_service<GetControllerJoints>("GetControllerJoints", 
																																						fcn5,
																																	rmw_qos_profile_services_default);
